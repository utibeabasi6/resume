...
export const about = {
  title: 'Profile',
  text: 'Utibeabasi Umanah is a DevOps engineer and Fullstack developer with over 3 years of experience. He is passionate about integrating devops culture to automate the developer workflow',
};
